            ...
            <div class="row">
              <div class="col-xs-12">
                ...
                <div class="alert alert-block alert-success">
                  ...
                  <strong class="green">
                    Ace
                    <small>(v1.4)</small> </strong
                  >, лёгкий, многофункциональный и простой в использовании
                  шаблон для админки на bootstrap 3.3.6. Загрузить исходники с
                  <a href="https://github.com/bopoda/ace">github</a> (with
                          ...
                          <div class="inline dropdown-hover">
                            ...
                            >
                              <li class="active">
                                <a href="#" class="blue">
                                  <i
                                    class="ace-icon fa fa-caret-right bigger-110"
                                    >&nbsp;</i
                                  >
                                  This Week
                                </a>
                        ...
                        <div class="widget-main">
                          ...
                          <div class="clearfix">
                            <div class="grid3">
                              <span class="grey">
                                <i
                                  class="ace-icon fa fa-facebook-square fa-2x blue"
                                ></i>
                                &nbsp; likes
                              </span>
                            ...
                            <div class="grid3">
                              <span class="grey">
                                <i
                                  class="ace-icon fa fa-twitter-square fa-2x purple"
                                ></i>
                                &nbsp; tweets
                              </span>
                            ...
                            <div class="grid3">
                              <span class="grey">
                                <i
                                  class="ace-icon fa fa-pinterest-square fa-2x red"
                                ></i>
                                &nbsp; pins
                              </span>
                          ...
                          <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="hidden-480">
                                  <span
                                    class="label label-warning arrowed arrowed-right"
                                    >SOLD</span
                                  >
                                </td>
                              </tr>
                        ...
                        <div class="widget-main padding-4">
                          <div class="tab-content padding-8">
                              ...
                              <ul id="tasks" class="item-list">
                                ...
                                <li class="item-red clearfix">
                                  ...
                                  <div class="pull-right action-buttons">
                                    ...
                                    <a href="#" class="green">
                                      <i
                                        class="ace-icon fa fa-flag bigger-130"
                                      ></i>
                                    </a>
                                  </div>
                                </li>
                                ...
                                <li class="item-default clearfix">
                                  ...
                                  <div
                                    class="pull-right pos-rel dropdown-hover"
                                  >
                                    <button
                                      class="btn btn-minier bigger btn-primary"
                                    >
                                      <i
                                        class="ace-icon fa fa-cog icon-only bigger-120"
                                      ></i>
                                    </button>
                                    ...
                                    >
                                      ...
                                      <li>
                                        ...
                                        >
                                          <span class="red">
                                            <i
                                              class="ace-icon fa fa-trash-o bigger-110"
                                            ></i>
                                          </span>
                                        </a>
                                      </li>
                            ...
                            <div id="member-tab" class="tab-pane">
                              <div class="clearfix">
                                  ...
                                  <div class="body">
                                    ...
                                    <div>
                                      ...
                                      <div class="inline position-relative">
                                        ...
                                        >
                                          <i
                                            class="ace-icon fa fa-angle-down icon-only bigger-120"
                                          ></i>
                                        </button>
                                        ...
                                        >
                                          ...
                                          <li>
                                            ...
                                            >
                                              <span class="orange">
                                                <i
                                                  class="ace-icon fa fa-times bigger-110"
                                                ></i>
                                              </span>
                                            </a>
                                          </li>
                                ...
                                <div class="itemdiv memberdiv">
                                  ...
                                  <div class="body">
                                    ...
                                    <div>
                                      <span
                                        class="label label-success label-sm arrowed-in"
                                        >approved</span
                                      >
                                    </div>
                                  </div>
                                ...
                                <div class="itemdiv memberdiv">
                                  ...
                                  <div class="body">
                                    ...
                                    <div>
                                      <span
                                        class="label label-info label-sm arrowed-in arrowed-in-right"
                                        >online</span
                                      >
                                    </div>
                                  </div>
                              ...
                              <div class="center">
                                <i
                                  class="ace-icon fa fa-users fa-2x green middle"
                                ></i>
                            ...
                            <div id="comment-tab" class="tab-pane">
                                ...
                                <div class="itemdiv commentdiv">
                                  ...
                                  <div class="tools">
                                    <div class="action-buttons bigger-125">
                                      <a href="#">
                                        <i
                                          class="ace-icon fa fa-pencil blue"
                                        ></i>
                                      </a>

                                      <a href="#">
                                        <i
                                          class="ace-icon fa fa-trash-o red"
                                        ></i>
                                      </a>
                                    </div>
                                  </div>
                              ...
                              <div class="center">
                                <i
                                  class="ace-icon fa fa-comments-o fa-2x green middle"
                                ></i>
                              ...
                              <div class="body">
                                ...
                                <div class="tools">
                                  <a href="#" class="btn btn-minier btn-info">
                                    <i
                                      class="icon-only ace-icon fa fa-share"
                                    ></i>
                                  </a>
                                </div>
                              </div>
                            ...
                            <div class="itemdiv dialogdiv">
                              ...
                              <div class="body">
                                ...
                                <div class="name">
                                  <a href="#">Bob</a>
                                  <span
                                    class="label label-info arrowed arrowed-in-right"
                                    >admin</span
                                  >
                                </div>
                                <div class="text">
